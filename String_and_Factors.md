...
``` r
weather_df %>%
  mutate(name = fct_relevel(name, c("Waikiki_HA", "CentralPark_NY", "Waterhole_WA"))) %>% ## reorder by releveling.
  ggplot(aes(x = name, y = tmax)) + 
  geom_violin(aes(fill = name), color = "blue", alpha = .5) + 
  theme(legend.position = "bottom")
```

<img src="String_and_Factors_files/figure-gfm/unnamed-chunk-13-1.png" width="90%" />
...
<img src="String_and_Factors_files/figure-gfm/unnamed-chunk-14-1.png" width="90%" />
...
<img src="String_and_Factors_files/figure-gfm/unnamed-chunk-23-1.png" width="90%" />
...
<img src="String_and_Factors_files/figure-gfm/unnamed-chunk-24-1.png" width="90%" />
...
<img src="String_and_Factors_files/figure-gfm/unnamed-chunk-26-1.png" width="90%" />
